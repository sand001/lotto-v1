...
<body>
  <div class="min-h-screen">
    ...
    if (file_exists($base_path . '/web/views/modules/navbar/navbar.php')) {
      include $base_path . '/web/views/modules/navbar/navbar.php'; 
    }
    if (file_exists($base_path . '/web/views/modules/hero/hero.php')) {
      include $base_path . '/web/views/modules/hero/hero.php'; 
    }
    if (file_exists($base_path . '/web/views/modules/faq/faq.php')) {
      include $base_path . '/web/views/modules/faq/faq.php'; 
    }
    if (file_exists($base_path . '/web/views/modules/footer/footer.php')) {
      include $base_path . '/web/views/modules/footer/footer.php'; 
    }
    ?>
  </div>
